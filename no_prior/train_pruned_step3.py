...
Train pruned nH-FCN, Step 3 (optimize only subject-level subnet)
"""
...
CENTER_MAT_NAME = 'patch_center_ad1'
...
PRUNED_NEIGHBORS = sio.loadmat('files/pruned_nns_idx_noprior.mat')
PRUNED_NEIGHBORS = PRUNED_NEIGHBORS['pruned_nns_idx']

PRUNED_PATCHES = sio.loadmat('files/pruned_pths_noprior.mat')
...
MODEL_NAME = 'pruned_nhfcn_step3.best.hd5'

HISTORY_NAME = 'pruned_nhfcn_step3_history'
...
if __name__ == '__main__':
    ...
    Net.load_weights(params['model_path']+'pruned_nhfcn_step2.best.hd5')
    Net.summary()
