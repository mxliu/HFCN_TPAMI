...
Train wH-FCN (i.e., with anatomical-landmark-based prior) from scratch...
"""
...
from sequential_loader import data_flow
...
SUBJ_LBLS = sio.loadmat('files/labels_ADNI1.mat')
SUBJ_LBLS = SUBJ_LBLS['labels_ADNI1']
SUBJ_LBLS[np.where(SUBJ_LBLS==-1)[0]] = 0
SUBJ_LBLS = (SUBJ_LBLS.flatten()).tolist()
...
HISTORY_NAME = 'whfcn_prior{0}_history'.format(PATCH_SIZE)
...
if __name__ == '__main__':
    ...
    train_flow = data_flow(img_path=params['trn_img_path'], 
                           ...
                           scale_range=[0.98, 1.02], flip_axis=0,
